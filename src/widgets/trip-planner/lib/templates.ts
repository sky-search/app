...
export const tripTemplates: TripTemplate[] = [
  {
    id: "tashkent-7-days",
    title: "7 Day Trip to Tashkent",
    coverImage:
      "https://www.thetravelmagazine.net/wp-content/uploads/Tashkent.jpg",
    prompt:
      "Plan a 7-day trip to Tashkent, Uzbekistan. I want to explore the historic Old City, visit the Chorsu Bazaar, see the Amir Timur Museum, and experience local cuisine. Include recommendations for traditional restaurants and hidden gems.",
  },
  {
    id: "astana-14-days",
    title: "14 Day Trip to Astana",
    coverImage:
      "https://cdn.getyourguide.com/img/location/5a1d41802404f.jpeg/99.jpg",
    prompt:
      "Create a 14-day itinerary for Astana, Kazakhstan. I'd like to see the Bayterek Tower, Khan Shatyr Entertainment Center, Palace of Peace and Reconciliation, and explore the modern architecture. Include day trips to nearby attractions.",
  },
  {
    id: "samarkand-5-days",
  ...
  {
    id: "bukhara-4-days",
    title: "4 Day Trip to Bukhara",
    coverImage: "https://ea-travel.uz/images/Night-in-Bukhara-banner.jpg",
    prompt:
      "Plan a 4-day trip to Bukhara, Uzbekistan. I want to explore the historic center, visit the Ark Fortress, Po-i-Kalyan complex, Lyab-i Hauz, and experience the ancient Silk Road atmosphere. Include local craft workshops and traditional cuisine.",
  },
  {
    id: "almaty-6-days",
    ...
    prompt:
      "Create a 6-day itinerary for Almaty, Kazakhstan. Include visits to Big Almaty Lake, Medeu skating rink, Shymbulak ski resort, Zenkov Cathedral, and Green Bazaar. Mix mountain adventures with city exploration.",
  },
  {
    id: "bishkek-5-days",
